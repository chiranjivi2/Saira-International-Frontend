              ...
              {section1 && (
                <div className="px-6 pb-6 pt-2 text-slate-700 space-y-4">
                  <p className="leading-relaxed">
                    Welcome to Saira International Education and Consultancy.
                  </p>
                  <p className="leading-relaxed">
                    Saira International Education and Consultancy ("us", "we",
                    or "our") operates sairainternational.com.np (hereinafter
                ...
                <div className="px-6 pb-6 pt-2 text-slate-700 space-y-3">
                  ...
                  <div className="border-l-2 border-blue-200 pl-4">
                    ...
                    <span className="text-slate-700">
                      ...
                      from those data (or from those and other information
                  ...
                  <div className="border-l-2 border-blue-200 pl-4">
                    ...
                    <span className="text-slate-700">
                      {" "}
                      is the individual using our Service. The User corresponds
              ...
              {section7 && (
                <div className="px-6 pb-6 pt-2 text-slate-700 space-y-4">
                  ...
                  <p className="leading-relaxed">
                    ...
                    data, including Personal Data, to Valletta, Malta and
                    process it there.
                  </p>
                  <p className="leading-relaxed">
              ...
              {section10 && (
                <div className="px-6 pb-6 pt-2 text-slate-700 space-y-4">
                  ...
                  <p className="leading-relaxed">
                    ...
                    please email us at sairainternationaledu@gmail.com.
                  </p>
                  <p className="leading-relaxed">
