          ...
          <div className=" grid grid-cols-1 lg:grid-cols-2 gap-20 items-center p-6">
            ...
            <div className="">
              ...
              <p className="text-justify text-lg leading-relaxed mb-8">
                ...
                people who want to go Abroad – whether for studying, working, or
                migrating permanently to their preferred destination. We provide
                100% Genuine and Correct information. Saira International
                Education and Consultancy started in the year 2025, for helping
                students. We are continuous helping students and providing free
                guidance since 2025. You can visit our social media links such
                as Instagram, Facebook, Tiktok for more information. You can
